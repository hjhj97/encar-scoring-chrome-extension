...
|  사고/보험이력 | 15점 | 최대 단일 사고 규모(신차가 대비 비율), 다중 사고 추가 감점 |
|  렌트이력 | 20점 | 렌트·영업용 사용 이력 여부 |
|  성능점검 | 15점 | 골격·외판 교환·판금·부식 랭크별 감점 (엔카진단++ 4점 가산, 진단 미적용 5점 감점) |
|  주행거리 | 10점 | 출고년월 기준 연간 평균 주행거리 |
|  소유주이력 | 15점 | 1인 소유(변경 0회) 만점, 변경 횟수에 따라 감점 (1회: -20%, 2회: -47%, 3회: -67%, 4회 이상: -100%) |

> **정보 비공개 페널티**: 보험이력이나 성능점검표를 비공개 처리한 매물은 조회 자체가 불가능하므로, 계산된 최종 점수에서 **무조건 40점이 감점**됩니다.
